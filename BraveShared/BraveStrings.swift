...
public extension Strings {
    ...
    public static let SyncInitErrorTitle = NSLocalizedString("SyncInitErrorTitle", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Sync initialization error.", comment: "Title for sync initialization error alert")
    public static let SyncInitErrorMessage = NSLocalizedString("SyncInitErrorMessage", tableName: "BraveShared", bundle: Bundle.braveShared, value: "Sync connection could not be estabilished. Please try again in few minutes.", comment: "Message for sync initialization error alert")
}
